...
replace (
	sigs.k8s.io/kustomize/api => github.com/sylr/kustomize/api v0.21.2-0.20260403151805-8f810fb2817b
	sigs.k8s.io/kustomize/kyaml => github.com/sylr/kustomize/kyaml v0.21.2-0.20260403151805-8f810fb2817b
)
...
require (
	...
	sylr.dev/yaml/age/v3 v3.1.1 // indirect
)
