...
replace (
	sigs.k8s.io/kustomize/api => github.com/sylr/kustomize/api v0.11.5-0.20220330074722-58fabe8a4459
...
require (
	...
	sylr.dev/yaml/age/v3 v3.0.0-20211029141500-720306745b0b // indirect
