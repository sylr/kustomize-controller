...
replace (
	sigs.k8s.io/kustomize/api => github.com/sylr/kustomize/api v0.19.1-0.20250708132342-72fa0610c8e5
...
require (
	...
	sylr.dev/yaml/age/v3 v3.0.0-20221203152643-412e9df4c040 // indirect
